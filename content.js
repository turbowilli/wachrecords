...
const siteContent = {
  ...
  work: {
    kicker:"Felix Wach", title:"Ausgewählte Arbeiten", intro:"Eine erste kuratierte Auswahl. Die Struktur ist bewusst offen gehalten, damit später eigenständige Serien wie Natur, Tierwelt oder Schwarz-Weiß ergänzt werden können.",
  ...
  legal: {
    ...
    legalNote:"Vor Veröffentlichung ergänzen. Diese Seite enthält die geschäftlichen Pflichtangaben und wird zentral in content.js gepflegt.",
    privacyAddress:"Rokamp 6a, 38542 Leiferde", privacyEmail:"foto@wachrecords.de", hosting:"GitHub Pages",
    privacyNote:"Hinweis: Die Website ist technisch bewusst datensparsam aufgebaut: keine externen Schriftarten, kein Tracking, kein Analytics und kein Kontaktformular. Der tatsächliche Datenschutzhinweis muss trotzdem an den später gewählten Hosting-Anbieter und alle ergänzten Dienste angepasst werden.",
